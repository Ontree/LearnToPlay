...
from keras.layers import (Activation, convolutional, Dense, Flatten, Input,
                          Merge, Embedding, Reshape, Permute, Reshape, multiply, Lambda, RepeatVector)
...
import gym
from codes.rle import rle
from codes.dqn import DQNAgent
from codes.objectives import mean_huber_loss
from codes.preprocessors import *
...
def main():  # noqa: D103
    ...
    agent.load_weights()
    agent.evaluate(env, 100, video_path_suffix='final', monitor = args.platform == 'atari')
    # env.close()
